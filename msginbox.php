...
<tr>
	<td colspan="4" align="center"><img src="/images/email_go.png" /> <b><?php echo $wikilang_inbox; ?></b> <img src="/images/email_open_image.png" /> <a href="/msgoutbox.php"><?php echo $wikilang_outbox; ?></a> <img src="/images/email_edit.png" /> <a href="/msgcreate.php"><?php echo $wikilang_compose; ?></a></td>
</tr>
<tr>
	<td>&nbsp;</td>
	<td class="NewsTitle"><?php echo $wikilang_msg_from; ?></td>
...
<input type="submit" value="<?php echo $wikilang_delete; ?>" name="inboxdel" class="coolBoton"/>
<input type="submit" value="<?php echo $wikilang_delete_all; ?>" name="inboxdelall" class="coolBoton"/>
</td>
</tr>
</table>
<?php
